...
import image40 from "@/assets/backofficesupport/dataentry1.png";
import image41 from "@/assets/backofficesupport/dataentry2.png";
...
const services = [
	{
		...
		description:
			"Accurate product uploads, attribute mapping and variant creation for large catalogs.",
		tags: ["catalog", "attributes"],
	},
	{
		title: "Invoice & PO Processing",
		description:
			"Fast, rule-driven invoice entry and PO reconciliation to keep accounting and inventory aligned.",
		tags: ["invoices", "POs"],
	},
	{
		title: "Product Attribute Enrichment",
		description:
			"Improve discoverability with optimized titles, bullets, specs and enhanced attributes.",
		tags: ["SEO", "enrichment"],
	},
	{
		title: "Data Cleansing & Deduplication",
		description:
			"Remove duplicates, normalize SKUs and validate data to reduce listing errors and returns.",
		tags: ["cleansing", "quality"],
	},
	{
		title: "Feed & Format Conversions",
		description:
			"CSV/XML/JSON feed transformations and integration-ready exports for marketplaces and platforms.",
		tags: ["feeds", "integrations"],
	},
	{
		title: "Image Tagging & Metadata",
		description:
			"Tagging, alt-text and metadata updates to ensure images improve SEO and accessibility.",
...
const faqs = [
	{
		...
		a: "Typical turnaround depends on volume — small batches (<=100 SKUs) within 48–72 hours; larger catalogs planned and scheduled with SLAs.",
	},
	{
		q: "How do you ensure data accuracy?",
		a: "We use validation rules, sampling QA and reconciliation steps to maintain high accuracy and minimize downstream issues.",
	},
	{
		q: "Can you integrate with our OMS/ERP?",
		a: "Yes — we support common integrations and can provide formatted exports compatible with major ERPs and marketplaces.",
	},
	{
		q: "Do you handle PII and sensitive fields?",
		a: "We follow data security best practices, can sign NDAs and only surface necessary fields to the processing pipeline.",
	},
	{
		q: "How are pricing and SLAs structured?",
		a: "We offer per-record pricing for high-volume tasks and time-and-materials or retainer models for ongoing operations.",
	},
];

export default function DataEntryManagementClient() {
		...
		>
			<section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
				...
				>
					...
					<p className="text-base text-gray-600 max-w-md">
						Reliable and scalable data entry operations for catalogs, orders and
						back-office feeds — designed to keep marketplaces and storefronts
			    ...
			    >
			      ...
			      />
					...
					<div className="mt-4 flex items-center gap-6">
						...
						<div className="text-sm">
							<div className="text-blue-600 font-bold">SLA</div>
				...
				>
					<div className="rounded-lg overflow-hidden shadow-lg bg-gray-50">
						<Image
							...
							alt={`Data entry showcase ${heroIndex + 1}`}
							width={1200}
							height={720}
			...
			<section id="services" className="mt-12">
				...
				<p className="text-slate-600 mt-2 mb-6 max-w-2xl">
					From catalog uploads to metadata enrichment and feed formatting, we
					handle the operational work so your team can focus on growth.
				</p>
