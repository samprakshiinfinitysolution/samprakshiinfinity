...
const services = [
    {
        title: "Custom Android App Strategy & Design",
        description: "Product strategy, UX design and prototyping to validate ideas before engineering begins.",
        image: image40,
        tags: ["Strategy", "UX"],
    },
    {
        title: "Native Android Development",
        description: "Kotlin-based native apps with modern architecture, offline-first capabilities and performant UI.",
        image: image41,
        tags: ["Kotlin", "Native"],
    },
    {
        title: "Cross-platform & React Native",
        description: "Shared codebases for iOS and Android when speed-to-market and maintenance are priorities.",
        image: image40,
        tags: ["React Native", "Cross-platform"],
    },
    {
        title: "Integrations & APIs",
        description: "Backend integrations, payment gateways, push notifications and analytics plumbing.",
        image: image41,
        tags: ["API", "Integrations"],
    },
    {
        title: "Performance & App Store Optimization",
        description: "App performance tuning, crash monitoring and ASO to improve discovery and retention.",
        image: image40,
        tags: ["Performance", "ASO"],
    },
    {
        title: "Support & Enterprise SLAs",
        description: "Managed releases, security patches and optional SLA-backed support plans.",
        image: image41,
        tags: ["Support", "SLA"],
    },
];
...
const faqs = [
    { q: "How long to build an Android app?", a: "Small apps: 6-10 weeks; medium: 3-4 months; complex enterprise apps: 6+ months depending on integrations." },
    { q: "Do you build native or cross-platform apps?", a: "We build both native (Kotlin) and cross-platform (React Native) depending on requirements." },
    { q: "Can you integrate with existing systems?", a: "Yes — we integrate with REST/GraphQL APIs, payment gateways, CRMs and analytics platforms." },
    { q: "Do you provide ongoing support?", a: "We offer maintenance plans, monitoring and SLA options for enterprise customers." },
    { q: "How do you handle app releases and store submission?", a: "We manage Play Store submissions, store guidelines, asset preparation and versioning." },
];

const AndroidAppDevelopmentClient = () => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
                <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
                    <nav className="text-sm text-gray-500" aria-label="Breadcrumb">
                        ...
                        <span className="text-gray-700 font-medium">Android App Development</span>
                    </nav>

                    <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Android App Development</h1>

                    <p className="text-base text-gray-600 max-w-md">
                        Build performant, user-friendly Android apps — native or cross-platform — designed to scale.
                    </p>
                    ...
                    <div className="mt-4 flex items-center gap-6">
                        <div className="text-sm">
                            ...
                            <div className="text-gray-500">Apps launched</div>
                        </div>
                        <div className="text-sm">
...
export default AndroidAppDevelopmentClient;
