...
//   title: "Google Flutter App Development - Samprakshi Infinity Solution",
//   description:
//     "Get cross-platform, high-performance Google Flutter app development services at Samprakshi Infinity Solution. Build apps that work seamlessly on both Android and iOS.",
//   keywords:
//     "Flutter app development, Google Flutter, mobile app development, cross-platform apps",
//   alternates: {
//     canonical: "https://www.samprakshiinfinitysolution.com/app-development/google-flutter-app-development",
//   },
// };
const services = [
    { title: "Cross-platform Strategy & Planning", description: "Roadmap, feature prioritization and performance targets for cross-platform delivery.", image: image42, tags: ["Strategy", "Roadmap"] },
    { title: "Flutter UI & Component Library", description: "Design systems and reusable widgets to speed development and ensure consistency.", image: image43, tags: ["Design", "Widgets"] },
    { title: "State Management & Architecture", description: "Robust architectures using Riverpod/Bloc to keep apps maintainable and testable.", image: image42, tags: ["Architecture", "State"] },
    { title: "Native Integrations & Plugins", description: "Custom platform channels and plugin work to access native device capabilities.", image: image43, tags: ["Plugins", "Native"] },
    { title: "Performance & Testing", description: "Rendering performance tuning, integration tests and device/CI test coverage.", image: image42, tags: ["Performance", "Testing"] },
    { title: "Maintenance & App Store Support", description: "Release management, updates and store submissions for both Play Store and App Store.", image: image43, tags: ["Support", "Releases"] },
];

const heroImages = [image42, image43];

const faqs = [
    { q: "Why choose Flutter?", a: "Flutter provides a single codebase for iOS/Android with performant rendering and expressive UI." },
    { q: "Do you support platform plugins?", a: "Yes — we build and maintain custom plugins and use platform channels for native features." },
    { q: "How do you approach testing?", a: "We use unit, widget and integration tests plus CI to ensure stability across releases." },
    { q: "Can you migrate existing apps?", a: "We can migrate or re-architect existing apps into Flutter when it makes sense strategically." },
    { q: "What about Flutter web or desktop?", a: "We can extend apps to web and desktop when the product case and performance allow it." },
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
                <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
                    <nav className="text-sm text-gray-500" aria-label="Breadcrumb">
                        ...
                        <span className="text-gray-700 font-medium">Google Flutter App Development</span>
                    </nav>

                    <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Google Flutter App Development</h1>

                    <p className="text-base text-gray-600 max-w-md">
                        Build beautiful, high-performance cross-platform apps with Flutter.
                    </p>
