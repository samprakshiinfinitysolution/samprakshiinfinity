...
//   title: "UI/UX Design Services - Samprakshi Infinity Solution",
//   description:
//     "Get beautiful and user-friendly UI/UX design services from Samprakshi Infinity Solution. Our expert designers create seamless and attractive interfaces.",
//   keywords:
//     "UI/UX design, user interface design, user experience design, mobile app design, web app design, Samprakshi Infinity Solution",
//   alternates: {
//     canonical:
//       "https://www.samprakshiinfinitysolution.com/app-development/mobile-uiux-design-development",
//   },
// };

const services = [
    { title: "Product Research & UX Strategy", description: "User research, journey mapping and feature prioritization to align UX with business goals.", image: image52, tags: ["Research", "Strategy"] },
    { title: "Interaction & Visual Design", description: "High-fidelity UI, motion design and accessible visual systems for delightful experiences.", image: image53, tags: ["Visual", "Motion"] },
    { title: "Design Systems & Component Libraries", description: "Reusable components, tokens and documentation to scale design across products.", image: image52, tags: ["Design System", "Components"] },
    { title: "Prototyping & Usability Testing", description: "Clickable prototypes and moderated testing to validate choices before engineering.", image: image53, tags: ["Prototyping", "Testing"] },
    { title: "UX for Mobile & Responsive", description: "Device-specific layouts and responsive patterns to ensure cross-device usability.", image: image52, tags: ["Mobile", "Responsive"] },
    { title: "Handoff & Collaboration", description: "Developer-ready assets, documentation and support during implementation and QA.", image: image53, tags: ["Handoff", "Collab"] },
];

const heroImages = [image52, image53];

const faqs = [
    { q: "Do you do user research?", a: "Yes — we run surveys, interviews and usability tests to inform product decisions." },
    { q: "Can you provide a design system?", a: "We create reusable design systems and component libraries tailored to your brand." },
    { q: "How do you validate designs?", a: "We prototype and conduct usability testing to validate flows before development." },
    { q: "Do you support engineering handoff?", a: "Yes — we deliver assets, specs and collaborate through the implementation phase." },
    { q: "What tools do you use?", a: "Figma, Sketch, Zeplin, and common testing/prototyping tools depending on project needs." },
];
        ...
        <section className="max-w-7xl mx-auto px-4 mt-16 py-12 bg-[#FFFFFF]" style={{ scrollMarginTop: '80px' }}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
                <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
                    ...
                    <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">UI & UX Design Services</h1>

                    <p className="text-base text-gray-600 max-w-md">
                        Create beautiful, usable interfaces that delight users and drive conversion.
                    </p>
