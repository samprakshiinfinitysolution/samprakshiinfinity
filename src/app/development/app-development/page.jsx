...
const services = [
  ...
  },
  {
    ...
    image: ANDROIDAPP,
    imageLeft: false,
    bgColor: "bg-[#F28379]", // light orange
  ...
  },
  {
    ...
    imageLeft: false,
    bgColor: "bg-[#D94436]", // light purple
  ...
  },
  {
    ...
    image: IONICAPP,
    imageLeft: true,
    bgColor: "bg-[#5C91F2]", // light yellow
  ...
  },
  {
    ...
    image: WEARABLEAPP,
    imageLeft: false,
    bgColor: "bg-[#C3A709]", // light yellow
  ...
  },
  {
    ...
    image: ARVRAPP,
    imageLeft: true,
    bgColor: "bg-[#7B50A4]", // light yellow
  ...
  },
  {
    ...
    imageLeft: false,
    bgColor: "bg-[#C5C827]", // light yellow
  ...
  },
  {
    ...
    image: CHROMECASTAPP,
    imageLeft: true,
    bgColor: "bg-[#CA5595]", // light yellow
...
const AppDevelopment = () => {
  ...
  // autoplay controls (match web-development behavior)
  ...
  return (
    <section className="relative bg-gray-50 mt-16" style={{ scrollMarginTop: '80px' }}>
      ...
      {/* HERO: compact subpage hero adapted from web-development */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
        <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3 items-center">
            {/* <Link href="/contact-us" className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-indigo-600 text-white font-medium hover:brightness-105 shadow-sm focus-visible:ring-2 focus-visible:ring-indigo-300">
              Get consultation
            ...
            {/* <Link href="#services" className="inline-flex items-center gap-2 px-3 py-2 rounded-md border border-gray-200 text-gray-700 bg-white hover:bg-gray-50 focus-visible:ring-2 focus-visible:ring-indigo-100">
              Explore services
            </Link> */}
          </div>
        ...
        <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative">
          <div className="rounded-lg overflow-hidden shadow-lg bg-white">
            ...
            {/* <div className="absolute left-4 bottom-4 bg-black/60 text-white text-xs px-2 py-1 rounded">Showcase</div> */}
          </div>
