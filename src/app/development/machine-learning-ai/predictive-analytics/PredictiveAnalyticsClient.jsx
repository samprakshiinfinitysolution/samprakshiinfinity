...
const services = [
    {
        ...
        description:
            "Robust forecasting (ARIMA, Prophet, deep learning) for sales, inventory and resource planning with uncertainty estimates and confidence intervals.",
        image: image50,
    ...
    },
    {
        ...
        description:
            "Demand signals, seasonality adjustments and inventory optimization to minimize stockouts and reduce holding costs using probabilistic forecasts.",
        image: image51,
        tags: ["Demand", "Inventory"],
    },
    {
        title: "Churn & Retention Models",
        description:
            "Predict customer churn, segment high-risk users and recommend targeted retention campaigns using explainable models and uplift analysis.",
        image: image50,
    ...
    },
    {
        ...
        description:
            "Real-time and batch anomaly detection for fraud, quality control and operational monitoring with alerting and root-cause signals.",
        image: image51,
    ...
    },
    {
        ...
        description:
            "Predictive models to estimate customer lifetime value and inform acquisition and personalization strategies with cohort analysis.",
        image: image50,
        tags: ["CLTV", "Cohorts"],
    },
    {
        ...
        description:
            "Prescriptive analytics and optimization (pricing, inventory allocation, scheduling) that translate forecasts into actionable decisions.",
        image: image51,
        tags: ["Prescriptive", "Optimization"],
    },
];
...
const faqs = [
    {
        q: "What data is needed for accurate forecasts?",
        a: "Historical time-series data, relevant exogenous features (promotions, holidays), and a clean measure of the target metric; we can help extract and augment missing signals.",
    },
    {
        q: "How do you handle seasonality and promotions?",
        a: "We model seasonal patterns, include promotion indicators and use hierarchical forecasting when you need forecasts at product/store granularity.",
    },
    {
        q: "Can models run in real time?",
        a: "Yes — we support streaming pipelines and low-latency inference for near-real-time monitoring, and batch forecasts for planning runs.",
    },
    {
        q: "How do you measure forecast accuracy?",
        a: "We use MAPE/MASE/RMSE and backtesting with rolling windows; we also evaluate business KPIs like stockouts or lost sales to measure impact.",
    },
    {
        q: "Do you provide integration with planning tools?",
        a: "Yes — we integrate with ERPs, BI tools and planning systems, and provide export pipelines and dashboards to operationalize forecasts.",
    },
];
        ...
        <section className="max-w-7xl mx-auto px-4 mt-16 py-12 bg-[#FFFFFF]" style={{ scrollMarginTop: '80px' }}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
                <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
                    ...
                    <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Predictive Analytics & Forecasting</h1>

                    <p className="text-base text-gray-600 max-w-md">
                        Forecast demand, detect anomalies, and convert predictions into decisions — planning-ready forecasts and prescriptive analytics for operations.
                    </p>
