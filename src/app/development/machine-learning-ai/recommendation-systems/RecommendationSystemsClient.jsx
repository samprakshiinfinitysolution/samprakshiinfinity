...
const services = [
    {
        ...
        image: image50,
        tags: ["Collaborative", "Matrix"],
    },
    {
        title: "Content-Based & Embedding Models",
        description:
    ...
    {
        title: "Hybrid & Graph-Based Recommenders",
        description:
    ...
    {
        title: "Real-time Recommendations & Streaming",
        description:
    ...
    {
        title: "Personalization, A/B Testing & Offline Eval",
        description:
        ...
        image: image50,
        tags: ["Personalization", "A/B"],
    },
    {
        title: "Ranking, Diversity & Bias Mitigation",
        description:
...
const faqs = [
    {
        ...
        a: "We use content-based and hybrid approaches, metadata enrichment and warm-start strategies (promotions, popularity boosts) to handle new users and items.",
    },
    {
        q: "What scale can you support?",
        a: "We design systems to scale horizontally with streaming ingestion, feature stores, caching layers and autoscaling serving infra to handle millions of users and items.",
    },
    {
        q: "How do you measure recommendation quality?",
        a: "We use offline metrics (HR, NDCG, MRR), business KPIs (CTR, conversion, revenue) and online A/B testing to assess impact and guide improvements.",
    },
    {
        q: "Can recommendations be made in real time?",
        a: "Yes — we support online feature updates, low-latency feature stores and optimized serving to deliver real-time personalized recommendations.",
    },
    {
        q: "How do you address fairness and bias?",
        a: "We apply re-ranking, diversity-promoting techniques and bias-detection tooling to ensure recommendations meet fairness and business constraints.",
    },
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
                <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
                    <nav className="text-sm text-gray-500" aria-label="Breadcrumb">
                        ...
                        <span className="text-gray-700 font-medium">Recommendation Systems</span>
                    </nav>

                    <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Recommendation Systems & Personalization</h1>
