...
import image40 from "@/assets/marketing/content-marketing1.png"
import image41 from "@/assets/marketing/content-marketing2.png"

const services = [
    { title: "Content Strategy & Audits", description: "Research-driven strategy, audience mapping and content audits to prioritise high-impact topics.", image: image40, tags: ["Strategy", "Audit"] },
    { title: "SEO Content", description: "Keyword-led long-form articles, cornerstones and topic clusters that drive organic traffic.", image: image41, tags: ["SEO", "Long-form"] },
    { title: "Short-form & Social", description: "Platform-specific short videos, threads and social posts to increase reach and engagement.", image: image40, tags: ["Social", "Video"] },
    { title: "Content Operations", description: "Editorial calendars, workflows and CMS integration to scale content reliably.", image: image41, tags: ["Ops", "CMS"] },
    { title: "Thought Leadership", description: "Whitepapers, research pieces and executive briefs that position your brand as an authority.", image: image40, tags: ["PR", "Leadership"] },
    { title: "Repurposing & Distribution", description: "Repurpose pillar content into syndication, newsletters and paid amplification.", image: image41, tags: ["Repurpose", "Distribution"] },
]

const heroImages = [image40, image41]

const faqs = [
    { q: "What channels do you publish to?", a: "We publish across blog platforms, social networks, newsletters and syndication partners depending on the strategy." },
    { q: "Do you do SEO-led content?", a: "Yes — we align content with keyword research, content hubs and on-page optimisation to help organic discovery." },
    { q: "Can you repurpose existing content?", a: "We audit existing content and create repurposing plans so existing assets deliver more value." },
]
        ...
        <section className="max-w-7xl mx-auto mt-16 px-4 py-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
                <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
                    ...
                    <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">CONTENT MARKETING</h1>

                    <p className="text-base text-gray-600 max-w-md">The content strategy is an integral part of any marketing plan — the creation, development, and maintenance of content in the form of text, images, audio or video. Content marketing helps brands to understand their target audience like never before. Content Marketing is the most effective and data-driven method for firms to reach new customers on their terms.</p>
                    ...
                    <div className="mt-3 flex items-center gap-2" aria-hidden>
                        {heroImages.map((img, i) => (
                            <button
                                ...
                                className={`w-12 h-8 rounded overflow-hidden border ${i === heroIndex ? 'ring-2 ring-sky-300' : 'border-gray-200'} focus:outline-none`}
                            >
