...
import image40 from "@/assets/marketing/email-marketing1.png";
import image41 from "@/assets/marketing/email-marketing2.png";

const services = [
  {
    title: "Lifecycle automation & onboarding",
    description: "Automated welcome and onboarding sequences that convert new signups into active users.",
    image: image40,
    tags: ["Onboarding", "Automation"],
  },
  {
    title: "Audience segmentation & personalization",
    description: "Data-driven segmentation and tailored content to increase open and click rates.",
    image: image41,
    tags: ["Segmentation", "Personalization"],
  },
  {
    title: "Campaign design & A/B testing",
    description: "Creative copy + templates and iterative testing to improve conversion over time.",
    image: image40,
    tags: ["Design", "A/B"],
  },
  {
    title: "Deliverability & list health",
    description: "Monitoring, warm-up and best practices to keep your messages reaching inboxes.",
    image: image41,
    tags: ["Deliverability", "Health"],
  },
  {
    title: "Lifecycle analytics & reporting",
    description: "Track revenue attribution, cohort performance and lifecycle KPIs across channels.",
    image: image40,
    tags: ["Analytics", "Attribution"],
  },
  {
    title: "Managed campaign services",
    description: "Full-service campaign planning, execution and optimization for sustained growth.",
    image: image41,
    tags: ["Managed", "Optimization"],
  },
];
...
const faqs = [
  { q: "How do you improve deliverability?", a: "We combine list hygiene, warm-up, content best-practices and monitoring to improve inbox placement." },
  { q: "What ESPs do you work with?", a: "We work with major ESPs (Braze, Klaviyo, Iterable, Mailchimp) and also support custom SMTP and API integrations." },
  { q: "Do you handle segmentation and personalization?", a: "Yes — audiences are segmented by behavior and value; we build personalized templates and test per-segment performance." },
  { q: "Can you help with revenue attribution?", a: "We implement tracking and attribution models to connect email activity to revenue and LTV metrics." },
  { q: "Do you offer managed services?", a: "Yes — from strategy to execution, we can run recurring campaigns and optimizations under an SLA." },
];
    ...
    <section className="max-w-7xl mx-auto px-4 mt-16 py-12 bg-white" style={{ scrollMarginTop: "80px" }}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
        <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
          ...
          <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Email Marketing</h1>

          <p className="text-base text-gray-600 max-w-md">We design segmented, automated email journeys that nurture prospects, re-engage users and drive conversion. Our campaigns combine copy, design and testing for measurable ROI.</p>
          ...
          <div className="mt-4 flex items-center gap-6">
            <div className="text-sm">
              ...
              <div className="text-gray-500">Campaigns run</div>
            </div>
            <div className="text-sm">
              <div className="text-blue-600 font-bold">40%</div>
              <div className="text-gray-500">Avg. uplift</div>
            </div>
          </div>
        </motion.div>
