...
const services = [
  { title: "Social strategy & planning", description: "Platform-specific strategies that align content, cadence and paid amplification to business goals.", image: image40, tags: ["Strategy", "Planning"] },
  { title: "Creative & short-form video", description: "Design and production of short-form creatives optimized for engagement and shareability.", image: image41, tags: ["Creative", "Video"] },
  { title: "Paid social campaigns", description: "Audience testing, creative experiments and budget allocation to maximize ROAS.", image: image40, tags: ["Paid", "Testing"] },
  { title: "Community & engagement", description: "Community management, moderation and organic growth programs to build lasting audiences.", image: image41, tags: ["Community", "Moderation"] },
  { title: "Influencer partnerships", description: "Identify and manage influencer collaborations that resonate with your audience and KPIs.", image: image40, tags: ["Influencer", "Partnerships"] },
  { title: "Analytics & reporting", description: "Channel-level and creative-level reporting that surfaces insights for optimization.", image: image41, tags: ["Analytics", "Reporting"] },
];

const heroImages = [image40, image41];

const faqs = [
  { q: "Which platforms should we prioritize?", a: "Prioritization depends on audience, creative fit and goals — we assess channel reach and conversion potential to recommend a mix." },
  { q: "Do you produce creative in-house?", a: "Yes — we have in-house producers for short-form video and can scale with trusted partners for larger shoots." },
  { q: "How do you measure success?", a: "We track engagement, view-throughs, conversion events and campaign-level ROI tailored to your goals." },
  { q: "Can you manage influencer programs?", a: "We handle scouting, contracts, creative alignment and reporting for influencer activations." },
  { q: "Do you run organic + paid together?", a: "Yes — we combine organic content, community work and paid amplification to accelerate growth." },
];
    ...
    <section className="max-w-7xl mx-auto px-4 mt-16 py-12 bg-white" style={{ scrollMarginTop: "80px" }}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
        <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="space-y-4">
          ...
          <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Social Media Marketing</h1>

          <p className="text-base text-gray-600 max-w-md">We plan and execute platform-specific social strategies that build awareness and drive engagement. Our approach combines creative, paid amplification and community management.</p>
          ...
          <div className="mt-4 flex items-center gap-6">
            <div className="text-sm">
              ...
              <div className="text-gray-500">Creatives produced</div>
            </div>
            <div className="text-sm">
              <div className="text-blue-600 font-bold">30%</div>
              <div className="text-gray-500">Avg. engagement uplift</div>
            </div>
          </div>
        </motion.div>
