...
export default function AboutSection() {
  ...
  return (
  <section className="bg-linear-to-b from-white to-[#f7faff] py-28 px-6 md:px-24 font-sans">
      {/* Intro */}
      ...
      <div className="max-w-6xl mx-auto mb-28">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-10" data-aos="fade-up">
          {coreValues.map(({ title, desc }, idx) => (
            <div
              key={idx}
              className="bg-linear-to-tr from-[#d9e8ff] to-[#f4f8ff] p-10 rounded-3xl shadow-md hover:shadow-lg transition cursor-default"
            >
  ...
  {/* Background blob */}
  <div className="absolute -top-20 -left-20 w-[500px] h-[500px] bg-linear-to-tr from-blue-300 via-purple-300 to-indigo-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse"></div>

  <div className="relative z-10 max-w-6xl mx-auto grid md:grid-cols-2 items-center gap-16">
    
    {/* Founder Image with ring */}
    <div className="flex justify-center items-center relative">
  <div className="absolute w-72 h-72 bg-linear-to-r from-blue-500 to-purple-500 rounded-full animate-spin-slow opacity-20" />
      <img
